...
| P11 | A handover is refused while an operation is unresolved | VERIFIED | REAL LOCAL FORK | `make hero-demo` step 5; 22 handover machine tests |
...
| P20 | The operator console shows real service state | PARTIAL | SYNTHETIC | Prototype; being connected |
